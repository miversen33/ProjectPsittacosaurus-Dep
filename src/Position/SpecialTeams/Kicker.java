...
public final class Kicker extends Position {
    ...
    private final static double BASE_RATING = 1.15;
    ...
    private final static double ACCURATE_SPEED_IMPORTANCE = .60;
    private final static double ACCURATE_STRENGTH_IMPORTANCE = .30;
    private final static double ACCURATE_AGILITY_IMPORTANCE = .55;
    private final static double ACCURATE_ACCELERATION_IMPORTANCE = .70;
    private final static double ACCURATE_AWARENESS_IMPORTANCE = .55;
    private final static double ACCURATE_BREAK_BLOCK_IMPORTANCE = .40;
    private final static double ACCURATE_KICK_POWER_IMPORTANCE = .75;
    ...
    private final static double POWER_SPEED_IMPORTANCE = .60;
    private final static double POWER_STRENGTH_IMPORTANCE = .30;
    private final static double POWER_AGILITY_IMPORTANCE = .55;
    private final static double POWER_ACCELERATION_IMPORTANCE = .70;
    private final static double POWER_AWARENESS_IMPORTANCE = .55;
    private final static double POWER_BREAK_BLOCK_IMPORTANCE = .40;
    private final static double POWER_KICK_POWER_IMPORTANCE = .9;
    private final static double POWER_KICK_ACCURACY_IMPORTANCE = .75;
    ...
    private final static double NEUTRAL_AGILITY_IMPORTANCE = .55;
    private final static double NEUTRAL_ACCELERATION_IMPORTANCE = .70;
    private final static double NEUTRAL_AWARENESS_IMPORTANCE = .55;
    private final static double NEUTRAL_BREAK_BLOCK_IMPORTANCE = .40;
    private final static double NEUTRAL_KICK_POWER_IMPORTANCE = .779;
    private final static double NEUTRAL_KICK_ACCURACY_IMPORTANCE = .779;
    ...
    public final static Kicker GenerateAccurateKicker(final int ovrSeed){
        ...
        kicker.updateModifiers(mods);
        kicker.seedRating(ovrSeed);
        return kicker;
    }

    public final static Kicker GeneratePowerKicker(final int ovrSeed){
    ...
    public final static Kicker GenerateNeutralKicker(final int ovrSeed){
