...
public final class Kicker extends Position{
    ...
    private final static BaseAttribute POWER_STRENGTH = new BaseAttribute(
        BaseAttributes.K_STRENGTH.getMean(), BaseAttributes.K_STRENGTH.getDeviation());
    private final static BaseAttribute POWER_SPEED = new BaseAttribute(
        BaseAttributes.K_SPEED.getMean(), BaseAttributes.K_SPEED.getDeviation());
    private final static BaseAttribute POWER_BREAK_BLOCK = new BaseAttribute(
        BaseAttributes.K_BREAK_BLOCK.getMean(), BaseAttributes.K_BREAK_BLOCK.getDeviation());
    private final static BaseAttribute POWER_TACKLE = new BaseAttribute(
        BaseAttributes.K_TACKLE.getMean(), BaseAttributes.K_TACKLE.getDeviation());
    private final static BaseAttribute POWER_RUN_BLOCKING = new BaseAttribute(
        BaseAttributes.K_RUN_BLOCKING.getMean(), BaseAttributes.K_RUN_BLOCKING.getDeviation());
    private final static BaseAttribute POWER_PASS_BLOCKING = new BaseAttribute(
        BaseAttributes.K_PASS_BLOCKING.getMean(), BaseAttributes.K_PASS_BLOCKING.getDeviation());
    private final static BaseAttribute POWER_CATCHING = new BaseAttribute(
        BaseAttributes.K_CATCHING.getMean(), BaseAttributes.K_CATCHING.getDeviation());
    private final static BaseAttribute POWER_CARRYING = new BaseAttribute(
        BaseAttributes.K_CARRYING.getMean(), BaseAttributes.K_CARRYING.getDeviation());
    private final static BaseAttribute POWER_ACCELERATION = new BaseAttribute(
        BaseAttributes.K_ACCELERATION.getMean(), BaseAttributes.K_ACCELERATION.getDeviation());
    private final static BaseAttribute POWER_BREAK_TACKLE = new BaseAttribute(
        BaseAttributes.K_BREAK_TACKLE.getMean(), BaseAttributes.K_BREAK_TACKLE.getDeviation());
    private final static BaseAttribute POWER_ELUSIVENESS = new BaseAttribute(
        BaseAttributes.K_ELUSIVENESS.getMean(), BaseAttributes.K_ELUSIVENESS.getDeviation());
    private final static BaseAttribute POWER_AGILITY = new BaseAttribute(
        BaseAttributes.K_AGILITY.getMean(), BaseAttributes.K_AGILITY.getDeviation());
    private final static BaseAttribute POWER_INJURY = new BaseAttribute(
        BaseAttributes.K_INJURY.getMean(), BaseAttributes.K_INJURY.getDeviation());
    private final static BaseAttribute POWER_STAMINA = new BaseAttribute(
        BaseAttributes.K_STAMINA.getMean(), BaseAttributes.K_STAMINA.getDeviation());
    private final static BaseAttribute POWER_THROW_POWER = new BaseAttribute(
        BaseAttributes.K_THROW_POWER.getMean(), BaseAttributes.K_THROW_POWER.getDeviation());
    private final static BaseAttribute POWER_MAN_COVERAGE = new BaseAttribute(
        BaseAttributes.K_MAN_COVERAGE.getMean(), BaseAttributes.K_MAN_COVERAGE.getDeviation());
    private final static BaseAttribute POWER_ZONE_COVERAGE = new BaseAttribute(
        BaseAttributes.K_ZONE_COVERAGE.getMean(), BaseAttributes.K_ZONE_COVERAGE.getDeviation());
    private final static BaseAttribute POWER_KICK_POWER = new BaseAttribute(
        BaseAttributes.K_KICK_POWER.getMean()+.025, BaseAttributes.K_KICK_POWER.getDeviation());
    private final static BaseAttribute POWER_KICK_ACCURACY = new BaseAttribute(
            BaseAttributes.K_KICK_ACCURACY.getMean()-.025, BaseAttributes.K_KICK_ACCURACY.getDeviation());
    ...
    private final static BaseAttribute ACCURATE_KICK_POWER = new BaseAttribute(
            BaseAttributes.K_KICK_POWER.getMean()-.05, BaseAttributes.K_KICK_POWER.getDeviation());
    private final static BaseAttribute ACCURATE_KICK_ACCURACY = new BaseAttribute(
            BaseAttributes.K_KICK_ACCURACY.getMean()+.05, BaseAttributes.K_KICK_ACCURACY.getDeviation());
    ...
    private final static BaseAttribute NEUTRAL_KICK_POWER = new BaseAttribute(
            BaseAttributes.K_KICK_POWER.getMean(), BaseAttributes.K_KICK_POWER.getDeviation());
    private final static BaseAttribute NEUTRAL_KICK_ACCURACY = new BaseAttribute(
            BaseAttributes.K_KICK_ACCURACY.getMean(), BaseAttributes.K_KICK_ACCURACY.getDeviation());
