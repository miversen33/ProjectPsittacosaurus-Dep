...
public final class Center extends Position{
    ...
    private final static BaseAttribute RUNBLOCK_AWARENESS = new BaseAttribute(
            BaseAttributes.C_AWARENESS.getMean(), BaseAttributes.C_AWARENESS.getDeviation());
    private final static BaseAttribute RUNBLOCK_STRENGTH = new BaseAttribute(
            BaseAttributes.C_STRENGTH.getMean()-.05, BaseAttributes.C_STRENGTH.getDeviation());
    private final static BaseAttribute RUNBLOCK_SPEED = new BaseAttribute(
            BaseAttributes.C_SPEED.getMean()+.05, BaseAttributes.C_SPEED.getDeviation());
    private final static BaseAttribute RUNBLOCK_BREAK_BLOCK = new BaseAttribute(
            BaseAttributes.C_BREAK_BLOCK.getMean(), BaseAttributes.C_BREAK_BLOCK.getDeviation());
    private final static BaseAttribute RUNBLOCK_TACKLE = new BaseAttribute(
            BaseAttributes.C_TACKLE.getMean(), BaseAttributes.C_TACKLE.getDeviation());
    private final static BaseAttribute RUNBLOCK_RUN_BLOCKING = new BaseAttribute(
            BaseAttributes.C_RUN_BLOCKING.getMean()+.15, BaseAttributes.C_RUN_BLOCKING.getDeviation());
    private final static BaseAttribute RUNBLOCK_PASS_BLOCKING = new BaseAttribute(
            BaseAttributes.C_PASS_BLOCKING.getMean()-.15, BaseAttributes.C_PASS_BLOCKING.getDeviation());
    private final static BaseAttribute RUNBLOCK_ACCELERATION = new BaseAttribute(
            BaseAttributes.C_ACCELERATION.getMean()+.05, BaseAttributes.C_ACCELERATION.getDeviation());
    private final static BaseAttribute RUNBLOCK_BREAK_TACKLE = new BaseAttribute(
            BaseAttributes.C_BREAK_TACKLE.getMean(), BaseAttributes.C_BREAK_TACKLE.getDeviation());
    private final static BaseAttribute RUNBLOCK_ELUSIVENESS = new BaseAttribute(
            BaseAttributes.C_ELUSIVENESS.getMean(), BaseAttributes.C_ELUSIVENESS.getDeviation());
    private final static BaseAttribute RUNBLOCK_AGILITY = new BaseAttribute(
            BaseAttributes.C_AGILITY.getMean(), BaseAttributes.C_AGILITY.getDeviation());
    private final static BaseAttribute RUNBLOCK_INJURY = new BaseAttribute(
            BaseAttributes.C_INJURY.getMean(), BaseAttributes.C_INJURY.getDeviation());
    private final static BaseAttribute RUNBLOCK_STAMINA = new BaseAttribute(
            BaseAttributes.C_STAMINA.getMean(), BaseAttributes.C_STAMINA.getDeviation());
    private final static BaseAttribute RUNBLOCK_THROW_POWER = new BaseAttribute(
            BaseAttributes.C_THROW_POWER.getMean(), BaseAttributes.C_THROW_POWER.getDeviation());
    private final static BaseAttribute RUNBLOCK_KICK_POWER = new BaseAttribute(
            BaseAttributes.C_KICK_POWER.getMean(), BaseAttributes.C_KICK_POWER.getDeviation());
    private final static BaseAttribute RUNBLOCK_KICK_ACCURACY = new BaseAttribute(
            BaseAttributes.C_KICK_ACCURACY.getMean(), BaseAttributes.C_KICK_ACCURACY.getDeviation());
    private final static BaseAttribute RUNBLOCK_THROW_ACCURACY = new BaseAttribute(
            BaseAttributes.C_THROW_ACCURACY.getMean(), BaseAttributes.C_THROW_ACCURACY.getDeviation());
    private final static BaseAttribute RUNBLOCK_ROUTE_RUNNING = new BaseAttribute(
            BaseAttributes.C_ROUTE_RUNNING.getMean(), BaseAttributes.C_ROUTE_RUNNING.getDeviation());
    ...
    private final static BaseAttribute PASSBLOCK_STRENGTH = new BaseAttribute(
            BaseAttributes.C_STRENGTH.getMean(), BaseAttributes.C_STRENGTH.getDeviation());
    ...
    private final static BaseAttribute NEUTRAL_SPEED = new BaseAttribute(
            BaseAttributes.C_SPEED.getMean(), BaseAttributes.C_SPEED.getDeviation());
    ...
    private final static BaseAttribute NEUTRAL_RUN_BLOCKING = new BaseAttribute(
            BaseAttributes.C_RUN_BLOCKING.getMean(), BaseAttributes.C_RUN_BLOCKING.getDeviation());
    private final static BaseAttribute NEUTRAL_PASS_BLOCKING = new BaseAttribute(
            BaseAttributes.C_PASS_BLOCKING.getMean(), BaseAttributes.C_PASS_BLOCKING.getDeviation());
    private final static BaseAttribute NEUTRAL_ACCELERATION = new BaseAttribute(
            BaseAttributes.C_ACCELERATION.getMean(), BaseAttributes.C_ACCELERATION.getDeviation());
    ...
    private Center(final String  subPositionName){
        super(PositionList.CENTER.getName(), subPositionName, BaseAttributes.C_ATTRIBUTES, POSITION_MEAN_OVERALL);
    }
    ...
    public final static Center GenerateRunblockCenter(final int overallSeed){
        ...
        center.setRatingsBuffs(buffs);
        center.overwriteAttributes(attrs);
        center.overwriteDeviations(devs);
    ...
    public final static Center GenerateNeutralCenter(final int overallSeed){
        ...
        final Center center = new Center(NEUTRAL_SUBPOSITION_NAME);
        center.setRatingsBuffs(buffs);
        center.overwriteAttributes(attrs);
        center.overwriteDeviations(devs);
        center.seedRating(overallSeed);
