...
import static Position.PositionList.STRONG_SAFETY;
...
public final class StrongSafety extends Position {
    ...
    private final static double BASE_RATING = .765;
    ...
    private final static double COVERAGE_SPEED_IMPORTANCE = .985;
    private final static double COVERAGE_AGILITY_IMPORTANCE = .95;
    private final static double COVERAGE_BREAK_BLOCK_IMPORTANCE = .40;
    private final static double COVERAGE_CARRYING_IMPORTANCE = .625;
    private final static double COVERAGE_CATCHING_IMPORTANCE = .70;
    private final static double COVERAGE_TACKLE_IMPORTANCE = .625;
    private final static double COVERAGE_STRENGTH_IMPORTANCE = .625;
    private final static double COVERAGE_ACCELERATION_IMPORTANCE = .975;
    private final static double COVERAGE_AWARENESS_IMPORTANCE = .80;
    private final static double COVERAGE_MAN_COVERAGE_IMPORTANCE = .70;
    ...
    private final static double HARDHITTER_AGILITY_IMPORTANCE = .925;
    private final static double HARDHITTER_BREAK_BLOCK_IMPORTANCE = .65;
    private final static double HARDHITTER_CARRYING_IMPORTANCE = .625;
    private final static double HARDHITTER_CATCHING_IMPORTANCE = .60;
    private final static double HARDHITTER_TACKLE_IMPORTANCE = .675;
    private final static double HARDHITTER_STRENGTH_IMPORTANCE = .70;
    private final static double HARDHITTER_ACCELERATION_IMPORTANCE = .925;
    private final static double HARDHITTER_AWARENESS_IMPORTANCE = .70;
    private final static double HARDHITTER_MAN_COVERAGE_IMPORTANCE = .60;
    private final static double HARDHITTER_ZONE_COVERAGE_IMPORTANCE = .60;
    ...
    private final static double NEUTRAL_AGILITY_IMPORTANCE = .925;
    ...
    private final static double NEUTRAL_AWARENESS_IMPORTANCE = .75;
    private final static double NEUTRAL_MAN_COVERAGE_IMPORTANCE = .65;
    private final static double NEUTRAL_ZONE_COVERAGE_IMPORTANCE = .66;

    private StrongSafety(final String subPositionName) {
        super(STRONG_SAFETY.getName(), subPositionName, BASE_RATING);
    }

    public final static StrongSafety GenerateCoverageStrongSafety(final int ovrSeed){
        ...
        strongSafety.updateAttributes(attrs);
        strongSafety.updateModifiers(mods);
        strongSafety.seedRating(ovrSeed);
        return strongSafety;
    }

    public final static StrongSafety GenerateHardHitterStrongSafety(final int ovrSeed){
    ...
    public final static StrongSafety GenerateNeutralStrongSafety(final int ovrSeed){
